...
export const calendarSizeMap: Record<CalendarSize, CalendarSizeConfig> = {
  sm: { cellSize: 28, fontSize: 12, headerFontSize: 13, gap: 2, padding: 8, dayHeaderFontSize: 11 },
  md: { cellSize: 36, fontSize: 13, headerFontSize: 14, gap: 2, padding: 12, dayHeaderFontSize: 12 },
  lg: { cellSize: 44, fontSize: 14, headerFontSize: 16, gap: 4, padding: 16, dayHeaderFontSize: 13 },
};
