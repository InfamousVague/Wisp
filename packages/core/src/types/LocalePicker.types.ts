...
export const localePickerSizeMap: Record<LocalePickerSize, LocalePickerSizeConfig> = {
  sm: { inputHeight: 28, fontSize: 12, iconSize: 14, borderRadius: 6, paddingX: 10, optionHeight: 32, searchHeight: 28 },
  md: { inputHeight: 34, fontSize: 13, iconSize: 16, borderRadius: 8, paddingX: 12, optionHeight: 36, searchHeight: 34 },
  lg: { inputHeight: 40, fontSize: 14, iconSize: 18, borderRadius: 8, paddingX: 14, optionHeight: 40, searchHeight: 40 },
};
