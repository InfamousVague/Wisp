...
export const progressSizeMap: Record<ComponentSize, ProgressSizeConfig> = {
  xs: { height: 4, borderRadius: 2, labelFontSize: 12, valueFontSize: 12 },
  sm: { height: 6, borderRadius: 3, labelFontSize: 13, valueFontSize: 13 },
  md: { height: 8, borderRadius: 4, labelFontSize: 14, valueFontSize: 14 },
  lg: { height: 10, borderRadius: 5, labelFontSize: 15, valueFontSize: 15 },
  xl: { height: 12, borderRadius: 6, labelFontSize: 16, valueFontSize: 16 },
};
